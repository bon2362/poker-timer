...
const CHANGELOG: ChangelogEntry[] = [
  {
    version: '4.67',
    date: "06 May '26",
    notes: 'Кнопки настроек и полноэкранного режима теперь скрываются вместе с управлением таймером при бездействии мыши.',
  },
  {
    version: '4.66',
    date: "06 May '26",
    notes: 'Двухстоловый режим: мобильная админ-панель группирует игроков по столам и позволяет переносить активных игроков между столами.',
  },
  {
    version: '4.65',
    date: "06 May '26",
  ...
  },
  {
    version: '4.62',
    date: "06 May '26",
    notes: 'Двухстоловый режим: мобильная админ-панель показывает и подтверждает диалог объединения столов.',
  },
  {
    version: '4.61',
    date: "06 May '26",
    notes: 'Двухстоловый режим: подтверждение объединения вызывает атомарный Supabase RPC и обновляет состояние через один refetch.',
  },
  {
    version: '4.60',
    date: "06 May '26",
    notes: 'Двухстоловый режим: при достижении порога объединения таймер автоматически ставится на паузу и показывает диалог подтверждения.',
  },
  {
    version: '4.59',
    date: "06 May '26",
    notes: 'Двухстоловый режим: активного игрока можно переместить между столами из раскрытого меню в панели игроков.',
  },
  {
    version: '4.58',
    date: "06 May '26",
    notes: 'Двухстоловый режим: основной таймер показывает количество активных игроков по столам в формате 3 / 2.',
  },
  {
    version: '4.57',
    date: "06 May '26",
    notes: 'Двухстоловый режим: панель игроков группирует активных участников по столам и показывает фишки в игре для каждого стола.',
  },
  {
    version: '4.56',
    date: "06 May '26",
    notes: 'Двухстоловый режим: старт сессии теперь блокируется при невалидной рассадке или пороге объединения.',
  },
  {
    version: '4.55',
    date: "06 May '26",
    notes: 'Двухстоловый режим: в настройках сессии появился выбор 1/2 столов, рассадка игроков и порог объединения.',
  },
  {
    version: '4.54',
    date: "06 May '26",
